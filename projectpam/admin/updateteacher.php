...
<body>
    ...
    <div class="container">
        <?php
        $id = $_GET['id'];
        $sql = "SELECT TCH_id, TCH_Username, TCH_fname, TCH_lname, TCH_email, TCH_password, TCH_department FROM $tableTCH WHERE TCH_id = '$id'";
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-sm-5">
                    <br>
                    <h3>แก้ไขผู้ใช้</h3>
                    <form action="./updateteacher_db.php" method="post">
